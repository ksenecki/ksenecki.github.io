      ...
      if (
        ...
        switch (p.type) {
          ...
          case 'table':
            ...
            for (
              o += this.renderer.tablerow(a), c = '', s = p.rows.length, n = 0;
              n < s;
              n++
            ) {
            ...
            y += this.renderer.table(o, c);
            continue;
          case 'blockquote':
            (c = this.parse(p.tokens)), (y += this.renderer.blockquote(c));
            continue;
          case 'list':
            for (
              u = p.ordered,
          ...
          case 'text':
            ...
            y += _ ? this.renderer.paragraph(c) : c;
            continue;
          default: {
...
function M(e, t, n) {
  ...
  if (
    ...
    const i = function (e) {
      ...
      if (!e)
        try {
          t.walkTokens && M.walkTokens(s, t.walkTokens), (i = Z.parse(s, t));
        } catch (t) {
          e = t;
        }
...
(M.options = M.setOptions =
  function (e) {
    var n;
    return _(M.defaults, e), (n = M.defaults), (t = n), M;
  }),
  (M.getDefaults = e),
  (M.defaults = t),
  (M.use = function () {
  ...
  (M.parseInline = function (e, t) {
    ...
    try {
      ...
      return t.walkTokens && M.walkTokens(n, t.walkTokens), Z.parseInline(n, t);
    } catch (e) {
      if (
        ((e.message +=
          '\nPlease report this to https://github.com/markedjs/marked.'),
